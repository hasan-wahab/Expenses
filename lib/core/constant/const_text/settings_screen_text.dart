class SettingsScreenText {
  static String get appBarText => 'Settings';
  static String get name => 'Ahmed Khan';
  static String get email => 'ahmed.khan@example.com';
  static String get accountSettings => 'ACCOUNT SETTINGS';
