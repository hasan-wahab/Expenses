...
class ExpensesRepo implements ExpenseRepoInter {
  ...
  @override
  Future<dynamic> addNewExpense({required ExpenseModel model}) async {
    await expenseLocalSource.addNewExpense(model: model);
  }

  @override
  Future<List<PropertyModel>> getPropertyCard() async {
    String currentUserEmail = await propertiesLocalSource.getCurrentUserEmail();
    return await propertiesLocalSource.getPropertiesList(
